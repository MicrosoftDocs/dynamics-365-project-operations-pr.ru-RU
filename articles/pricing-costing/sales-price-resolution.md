...
description: В этой статье содержится информация о том, как рассчитать значение цены продажи для оценок и фактических значений.
author: rumant
ms.date: 04/07/2021
ms.topic: article
...
## <a name="resolve-sales-rates-on-actual-and-estimate-lines-for-material"></a>Разрешение ставок продаж по строкам фактических данных и оценок для материала
