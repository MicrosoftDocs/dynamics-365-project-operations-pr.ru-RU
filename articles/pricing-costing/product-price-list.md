...
description: В этой статье содержится информация о прайс-листах в ценообразовании для каталога, используемых в предложениях с расценками и контрактах проектов.
author: rumant
ms.date: 04/05/2021
ms.topic: article
ms.prod: ''
