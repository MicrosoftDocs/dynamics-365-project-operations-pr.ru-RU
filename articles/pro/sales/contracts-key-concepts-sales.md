---
title: Уникальные понятия для контрактов по проекту
description: В этой статье приведено описание основных понятий контрактов по проектам.
author: rumant
ms.date: 10/07/2020
ms.topic: article
