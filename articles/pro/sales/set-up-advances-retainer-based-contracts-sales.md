...
description: В этой статье содержится информация о моделях заключения контрактов с предоплатой и на основе авансовых платежей в Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
