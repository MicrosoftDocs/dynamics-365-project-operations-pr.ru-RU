---
title: Сопоставление проектов и задач со строкой контракта по проекту
...
ms.locfileid: "9825075"
---
# <a name="map-projects-and-tasks-to-a-project-contract-line"></a>Сопоставление проектов и задач со строкой контракта по проекту 
...
В строках контракта по проекту можно сопоставлять конкретные задачи в проекте со строкой контракта.
...
## <a name="associate-tasks-to-project-contract-lines"></a>Связывание задач со строками контракта по проекту
