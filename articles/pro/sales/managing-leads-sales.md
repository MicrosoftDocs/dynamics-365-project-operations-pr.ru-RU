...
description: В этой статье приведены инструкции по управлению интересами на основе проекта (для продвинутых пользователей).
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "8911612"
---
# <a name="manage-leads---lite"></a>Управление интересами — облегченное развертывание
...
В разделе **Продажи** в левой навигационной панели откройте страницу списка **Интересы**, чтобы просмотреть список всех записей интересов в системе. Интересы в списке — это рабочие и другие типы интересов, которые могут быть созданы, если у вас также есть приложения Dynamics 365 Sales или Dynamics 365 Field Service.
