---
title: Управление несколькими клиентами в строках контракта по проекту
...
ms.locfileid: "9825957"
---
# <a name="manage-multiple-customers-on-project-contract-lines"></a>Управление несколькими клиентами в строках контракта по проекту
