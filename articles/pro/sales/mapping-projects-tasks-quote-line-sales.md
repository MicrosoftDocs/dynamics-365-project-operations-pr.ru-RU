---
title: Сопоставление проектов и задач со строками предложения с расценками по проекту
description: В этой статье содержатся инструкции по сопоставлению проектов и задач со строками предложения с расценками по проекту.
author: rumant
ms.date: 10/05/2020
ms.topic: article
...
ms.locfileid: "9824363"
---
# <a name="map-projects-and-tasks-to-project-quote-lines"></a>Сопоставление проектов и задач со строками предложения с расценками по проекту

_**Относится к:** Project Operations для сценариев на основе ресурсов/нескладируемых запасов, упрощенное развертывание — от сделки до выставления счетов-фактур_

В строках предложения с расценками по проекту можно сопоставлять конкретные задачи проекта, который уже связаны со строкой предложения с расценками.
