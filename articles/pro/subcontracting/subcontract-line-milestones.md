...
4. На странице **Создать веху строки субподряда** введите необходимую информацию на основе следующей таблицы.
    ...
    | Поле | Описание |
    | --- | --- |
    | Имя вехи | Название вехи. |
    | Описание | Описание вехи.  |
    | Дата вехи | Дата, когда процесс автоматического создания накладной должен определить статус этой вехи, чтобы учесть ее при выставлении счета. Это значение включается в строку накладной поставщика при выставлении накладной по этому субподряду. |
    | Сумма | Сумма или значение вехи, по которой клиенту будет выставлен счет. Это значение включается в строку накладной поставщика при выставлении накладной по этому субподряду. |
    | Налог | Сумма налога, примененная к вехе. Это значение включается в строку накладной поставщика при выставлении накладной по этому субподряду. |
    | Сумма после налогообложения | Это доступное только для чтения поле, рассчитываемое как сумма плюс налог. Это значение включается в строку накладной поставщика при выставлении накладной по этому субподряду. |
