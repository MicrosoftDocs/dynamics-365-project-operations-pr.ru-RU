...
description: В этой статье содержатся инструкции по работе со счетами-проформами по проектам.
author: rumant
ms.date: 04/05/2021
ms.topic: article
...
ms.locfileid: "8923020"
---
# <a name="manage-a-proforma-project-invoice"></a>Управление счетом-проформой по проекту 
...
| **Выбрать продукт** | Задается по умолчанию из фактических данных источника, это поле только для чтения. | Когда вы создаете новые сведения строки счета без подтверждения фактических данных, это поле можно редактировать. |
| **Товар** | Задается по умолчанию из фактических данных источника, это поле только для чтения. | Когда вы создаете новые сведения строки счета без подтверждения фактических данных, это поле можно редактировать, если поле **Выбрать продукт** задано как **Существующий продукт**. |
| **Название продукта** | Задается по умолчанию из фактических данных источника, это поле только для чтения. | В новых сведениях строки счета, где артикул выбирается из каталога, в этом поле задается имя продукта. Для вписанного продукта в поле задается название вписанного. |
| **Описание вписанного** | Задается по умолчанию из фактических данных источника, это поле только для чтения. | Когда вы создаете новые сведения строки счета без подтверждения фактических данных, вы можете добавить описание вписанного продукта. |
