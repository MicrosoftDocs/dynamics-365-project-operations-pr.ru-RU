...
description: В этой статье содержится информация о том, как выставить счет на предоплату или аванс в Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
