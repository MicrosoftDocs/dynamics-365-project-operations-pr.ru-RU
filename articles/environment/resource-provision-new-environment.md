...
2. В списке **Предварительная версия функции** выберите **Project Operations** и выберите **Функция предварительного просмотра включена**, чтобы включить Project Operations.
...
| **Сущность интеграции Project Operations для оценки часов (msdyn\_resourceassignments)** | No | No | Неприменимо | No | Неприменимо |
...
5. После завершения обновления продолжите запуск сопоставления.

![Обновление сопоставления](./media/20RefreshMapping.png)

Прежде чем включить следующее сопоставление, убедитесь, что сопоставление в таблице находится в состоянии **Запущено**. Запуск сопоставлений с большим количеством предварительных условий может занять некоторое время.
