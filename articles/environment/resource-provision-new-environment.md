...
5. Выберите оба решения — **Сопоставление сущностей для двойной записи Dynamics 365 Finance** и **Сопоставления сущностей для двойной записи Dynamics 365 Project Operations**, затем выберите **Применить**.
