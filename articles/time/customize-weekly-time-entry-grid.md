...
description: В этой статье содержится информация о том, как разработчики могут расширить возможности элемента управления записью времени.
author: stsporen
ms.date: 01/27/2022
ms.topic: article
