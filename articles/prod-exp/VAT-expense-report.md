---
title: Возврат НДС
description: В этой статье описан порядок получения возврата денежных средств по транзакциям с налогом на добавленную стоимость (НДС).
author: saraschi2
ms.date: 02/26/2018
ms.topic: article
ms.prod: ''
