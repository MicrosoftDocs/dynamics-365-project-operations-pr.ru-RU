...
description: В этой теме приведена информация о том, как создавать и подтверждать журналы записей в Microsoft Dynamics 365 Project Operations.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
