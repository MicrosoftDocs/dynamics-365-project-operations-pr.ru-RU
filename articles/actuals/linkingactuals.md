...
description: В этой теме поясняется, как концепия происхождений проводок используетя для связывания фактических значений с их записями-источниками, такими как записи времени, записи расходов или журналы использования материалов.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
