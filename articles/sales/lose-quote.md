---
title: Копирование предложений с расценками по проекту
description: В этой статье содержатся инструкции по копированию предложений с расценками по проекту в Project Operations.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825323"
---
# <a name="copy-project-quotes"></a>Копирование предложений с расценками по проекту
