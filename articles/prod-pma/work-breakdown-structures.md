...
Создание WBS — это интенсивный процесс, который обычно выполняется в течение длительного периода и требует сотрудничества и информации от самых разных людей. В этой статье описывается, как использовать усовершенствования WBS, чтобы удовлетворить требования к оценкам и отслеживанию.
...
В представлении «Планирование» отображается плановая или базовая оценка расписания и информация о затратах. Хотя для проекта WBS нет функций для отслеживания версии и базовых показателей, значения в этом представлении предназначены для представления базовой версии. В разделах "Оценка графика" и "Оценка стоимости" этой статьи описывается это представление и то, как оно используется для создания WBS.
