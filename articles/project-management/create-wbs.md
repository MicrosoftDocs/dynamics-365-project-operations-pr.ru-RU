...
description: В этой статье объясняется, как создать структурную декомпозицию работ (WBS), включая базовые элементы управления в новом интерфейсе планирования.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
...
## <a name="understanding-the-impacts-of-duration-resource-calendars-and-project-calendars-on-tasks"></a>Разбор влияния продолжительности, календарей ресурсов и календарей проектов на задачи
Продолжительность задачи определяется как количество рабочих часов между временем начала даты начала и временем окончания даты окончания задачи.   Project for the Web определяет единицы измерения длительности следующим образом:

| **Единица измерения длительности** | **Количество**|
|----------------------------------------------------|----------------------|
| Часов в день | 8 |
| Часов в неделю |  40 |
| Дней в месяц |  20 |

Неназначенные задачи планируются с помощью календаря проекта. Однако при первоначальном назначении ресурса расписание задачи обновляется таким образом, чтобы оно соответствовало календарю ресурса. Последующие изменения задачи с назначением будут регулироваться [режимом планирования](scheduling-modes.md) проекта. Чтобы узнать больше о влиянии календарей на задачи, см. разделы [Календари ресурсов в Project for the Web](https://techcommunity.microsoft.com/t5/project-blog/resource-calendars-in-project-for-the-web/ba-p/3269686) и [Время начала задач и ваши проекты](https://techcommunity.microsoft.com/t5/project-blog/task-start-times-amp-your-projects/ba-p/3269665)
...
## <a name="project-limitations"></a>Ограничения проекта 
Вы должны знать о следующих ограничениях, если используете структурную декомпозицию работ в Project Operations. Эти ограничения применяются к проектам и задачам. Дополнительную информацию см. в разделе [Ограничения и границы Project for the Web](/project-for-the-web/project-for-the-web-limits-and-boundaries).
