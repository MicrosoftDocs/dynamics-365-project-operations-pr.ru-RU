...
description: В этой статье содержится информация о том, как работать с информацией об участниках проектной группы, атрибутами и расписанием.
author: ruhercul
ms.date: 10/01/2020
ms.topic: overview
